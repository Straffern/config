...
in
  python312.pkgs.buildPythonApplication rec {
    ...
    src = fetchurl {
      url = "https://files.pythonhosted.org/packages/ea/59/ebda469d74a1e18f68e0a231dd26127585d75d5a06c58dd5be1befd831fd/amd_debug_tools-0.2.11-py3-none-any.whl";
    ...
    meta = with lib; {
      description = "Debug tools for AMD systems (amd-s2idle, amd-bios, amd-pstate, amd-ttm)";
